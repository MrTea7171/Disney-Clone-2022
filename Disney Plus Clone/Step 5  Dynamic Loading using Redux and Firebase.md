1. Creating Movie Slice:

   1. Create movie folder in features. Create moviesSlice.jsx inside movies folder.

   2. Create initial data inside the slice
   ...
   3. Create Movie Slice inside the file
   ...
   4. Export bunch of stuff you get from slice
   ...
   5. Boom the file is complete 💯. Final Look should be like this. #complete:
   ...
   6. Include movieSlice in store.jsx
...
2. Uploading Data to Firebase:
   ...
   1. The data you need to upload on firebase.
   ...
   2. Go to [Firebase](https://console.firebase.google.com/ "Link"). Go to Cloud FireStore. Create in Test Mode and choose default server.

   3. Click on Start Collection. Give it name ‘*disneyMovies*’. Enter data inside the storage.

3. Fetching Data from the FireBase

   1. In Home.jsx add these imports
   ...
   2. Inside Home Component add these declaration
   ...
   3. Add UseEffect Hook Inside the Home Component
   ...
   4. Loading Data in Recommends Component
   ...
   5. Loading Data in Originals Component
   ...
   6. Loading Data in New Disney Component
   ...
   7. Loading Data in Trending Component
